	...
	tests := []struct {
		...
		},
		{
			...
			wantPL: numaplacement.Payload{
				...
				BusiestNode:    0,
				VectorEncoding: VectorEncodingPlain,
				Vectors:        map[int]string{1: "ns2/pod1/cnt1"},
			},
		},
		{
			...
			wantPL: numaplacement.Payload{
				...
				BusiestNode:    0,
				VectorEncoding: VectorEncodingPlain,
				Vectors:        map[int]string{1: "ns2/pod1/cnt1|ns2/pod2/cnt1"},
			},
		},
		{
			...
			wantPL: numaplacement.Payload{
				...
				BusiestNode:    1,
				VectorEncoding: VectorEncodingPlain,
				Vectors:        map[int]string{0: "ns1/pod1/cnt1"},
			},
		},
		{
			...
			wantPL: numaplacement.Payload{
				...
				BusiestNode:    0,
				VectorEncoding: VectorEncodingPlain,
				Vectors:        map[int]string{1: "ns2/pod4/cnt1", 2: "ns3/pod5/cnt1"},
			},
		},
	}
